...
import UI.BaseView.Body.Components.Loans.CustomerView.SingleLoanController;
import UI.BaseView.Body.Components.Notifications.NotificationAreaController;
import UI.BaseView.Body.Components.Notifications.ScrambleAreaController;
import UI.BaseView.Body.Components.Notifications.notificationPopUpController;
import UI.BaseView.Body.Components.Transactions.ChargeController;
import UI.BaseView.Body.Components.Transactions.Payments.PayMeController;
import UI.BaseView.Body.Components.Transactions.SingleTransactionController;
import UI.BaseView.Body.Components.Transactions.WithdrawController;
import UI.BaseView.Body.Components.UiAdapter.UiAdapter;
import UI.BaseView.Body.CustomerView.Task.task;
