...
@WebServlet(name="=ListNotifications", urlPatterns = {"/listNotifications"})
public class ListNotificationsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (usernameFromParameter == null || usernameFromParameter.equals(USERNAME)) {
            ...
            Notification[] notifications = engine.getCustomersNotifications(usernameFromParameter).toArray(new Notification[0]);
